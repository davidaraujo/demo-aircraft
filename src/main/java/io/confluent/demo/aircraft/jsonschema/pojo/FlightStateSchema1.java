...
public class FlightStateSchema1 {
    ...
    public String toString() {
        ...
        sb.append(FlightStateSchema1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("icao24");
        sb.append('=');
