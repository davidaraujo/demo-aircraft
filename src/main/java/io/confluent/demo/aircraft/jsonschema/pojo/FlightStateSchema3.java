...
public class FlightStateSchema3 {
    ...
    /**
     * The gate on ground. Can be null.
     * 
     */
    @JsonProperty("gate")
    @JsonPropertyDescription("The gate on ground. Can be null.")
    private String gate;
    ...
    public String toString() {
        ...
        sb.append(FlightStateSchema3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("icao24");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.gate == null)? 0 :this.gate.hashCode()));
